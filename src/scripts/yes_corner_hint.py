...
hyperparameters = {
    'model_name': 'yes_corner_hint',
    'description': "Training the model on dataset with hint at (0,0)."
                   "Want to test if it can perform well on data with no hint at (0, 0).",
    'device': 6,
    'dim_x': 2,
    'dim_y': 2,
    'num_hints': 6,
...
dataset = Dataset.load(SUDOKU_PATH + '/data/4x4_with_hint_6.pkl')
with_one = read_solutions_file(SUDOKU_PATH + '/data/4x4_without_hint_6.sol')
